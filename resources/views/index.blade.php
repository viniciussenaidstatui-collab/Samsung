                ...
                <div class="card-body">
                    <form id="formSamsung">
                        <div class="mb-3">
                            ...
                            <input type="text" id="aparelho" class="form-control" placeholder="Ex: Galaxy S24">
                        </div>
                        <div class="mb-3">
                            <label class="form-label small text-uppercase fw-bold">Modelo</label>
                            <input type="text" id="modelo" class="form-control" placeholder="Ex: Ultra / Plus">
                        </div>
                        <div class="row">
                            <div class="col-6 mb-3">
                                <label class="form-label small text-uppercase fw-bold">Cor</label>
                                <input type="text" id="cor" class="form-control" placeholder="Titanium">
                            </div>
                            <div class="col-6 mb-3">
                        ...
                        <button type="button" onclick="salvarAparelho()" class="btn btn-purple w-100 mt-3">
...
<script>
    ...
    // FUNÇÃO QUE MOSTRA A TABELA (ÚNICA ATIVA POR ENQUANTO)
    ...
    // Função salvar (preparada para quando seu professor ensinar)
    async function salvarAparelho() {
        ...
        try {
            const response = await fetch(`${API_URL}/salva_samsung`, {
                method: 'POST',
            ...
            const data = await response.json();
            if(data.erro === 'n') {
                alert("Sucesso! Aparelho registrado.");
                carregarProdutos();
                document.getElementById('formSamsung').reset();
            }
        } catch (e) {
