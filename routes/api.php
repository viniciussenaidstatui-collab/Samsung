...
Route::post('/carrinho/checkout', [TestController::class, 'checkout']);
...
Route::middleware([auth_api::class])->group(function () {
    ...
    // Boleto — gerar (web.php já tem a rota pública POST /gerar-boleto)
    // Esta rota autenticada permite listar boletos do usuário
    Route::get('/listar_boletos', [UsuarioController::class, 'listar_boletos']);
